...
class FteMonthLine(models.Model):
    ...
    def _compute_fte_line_message(self):
        for line in self:
            # No fixed hours: optional or empty message
            ...
            if not line.executed_hours:
                # Still within fixed hours
                line.fte_line_message = _(
                ...
                # Fixed hours have been exceeded, executed_hours are hours beyond fixed hours
                line.fte_line_message = _(
                    "<p>This project has <b>%(fixed)s&nbsp;fixed hours</b> for the month.</p>"
